...
@st.cache_resource 
def load_model():
    primary_path = 'streamlit_gallery/utils/best_model_bank_marketing.joblib'
    alternative_path = '../../utils/best_model_bank_marketing.joblib'
...
@st.cache_resource
def load_pipeline():
    primary_path = 'streamlit_gallery/utils/best_pipeline_bank_marketing.joblib'
    alternative_path = '../../utils/best_pipeline_bank_marketing.joblib'
...
@st.cache_resource
def load_trials():
    primary_path = 'streamlit_gallery/utils/hyperopt_trials.csv'
    alternative_path = '../../utils/hyperopt_trials.csv'
